...
describe Order, "related accounts" do
  ...
  context OrderAsk do
    it "should hold btc and expect usd" do
      ...
      ask.expect_account.should == alice.get_account(:usd)
    end
  end
  ...
  context OrderBid do
    it "should hold usd and expect btc" do
      ...
      bid.hold_account.should == bob.get_account(:usd)
...
describe Order, "#avg_price" do
  ...
  it "should calculate average price of bid order" do
    OrderBid.new(currency: 'btcusd', locked: '10.0', origin_locked: '20.0', volume: '1.0', origin_volume: '3.0', funds_received: '2.0').avg_price.should == '5'.to_d
  end

  it "should calculate average price of ask order" do
    OrderAsk.new(currency: 'btcusd', locked: '1.0', origin_locked: '2.0', volume: '1.0', origin_volume: '2.0', funds_received: '10.0').avg_price.should == '10'.to_d
  end
end
